            ...
            <div className="flex items-center gap-4">
                ...
                {user && (
                    <Button
                        ...
                        disabled={isLoading}
                        className={isConnected ? "bg-green-600 hover:bg-green-700 text-white flex items-center gap-2" : "border-green-600 text-green-600 hover:bg-green-50 hover:text-green-700 flex items-center gap-2"}
                    >
                        ...
                        {isLoading ? "Loading..." : isConnected ? "WhatsApp Connected" : "Connect WhatsApp"}
                    </Button>
                )}
            </div>
