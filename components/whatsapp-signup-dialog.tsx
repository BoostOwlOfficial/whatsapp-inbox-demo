...
export function WhatsAppSignupDialog({ open, onOpenChange }: WhatsAppSignupDialogProps) {
    const { isLoading, error, accountStatus, launchSignup } = useWhatsAppSignup()
    ...
    const handleSignup = async () => {
        try {
            ...
            setLocalError(err instanceof Error ? err.message : 'Failed to connect WhatsApp')
        }
    }
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                ...
                <div className="text-xs text-slate-500 text-center">
                    ...
                    <a href="https://www.whatsapp.com/legal/business-terms" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                        Business Terms
                    </a>
                </div>
            </DialogContent>
